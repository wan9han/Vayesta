...
| **22680** | 1710.6s (~28.5min) | 561.6s | 388.0s | 758.0s |

22680 节点（1.81 亿原子）：实测 wall **1710.6s（~28.5 min）**、峰值内存 ~80 GB、输出 **37 GB**（22680 block + 22679 dimer + 22679 cap，每个 input.fdf + 赝势符号链接 + run_local.sh）。其中：
